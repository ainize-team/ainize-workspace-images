echo "Run Jupyter Notebook & VSCode & TTYD"
...
# Do not change the port number from 8000.
...
# Do not change the port number from 8010.
export PORT="8010"
...
# Do not change the port number from 8020.
